// KeyFlow - Word list and generator
const WORDS = [
  ...
  "need","large","often","hand","high","place","hold","turn","been","part","same",
  "tell","does","set","three","air","put","end","does","another","well","large",
  "need","big","play","spell","add","land","here","must","such","follow","act","why",
  "ask","men","change","went","light","kind","off","need","house","picture","try",
  ...
  "white","children","begin","got","walk","example","ease","paper","often","always",
  ...
  "heard","best","hour","better","during","hundred","five","remember","step","early",
  ...
  "box","noun","field","rest","able","pound","done","beauty","drive","stood","contain",
  ...
  "ago","ran","check","game","shape","equate","hot","miss","brought","heat","snow",
...
function generateWords() {
  ...
  const result = [];
  while (result.length < WORD_COUNT) result.push(...shuffled);
  return result.slice(0, WORD_COUNT);
}
